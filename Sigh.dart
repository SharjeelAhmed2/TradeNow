...
class _LoginPageState extends State<LogPage> {
  ...
  fontWeight: FontWeight.w500,fontSize: 20),)
            ...
            SizedBox(height: 25.0,),// End of Remember me
             Container(
              height: 50,
              width: 300,
              decoration: BoxDecoration(
              ...
              (
                ...
                child: Row(children: [
                  Text("Already have an account?", style: TextStyle(fontWeight: FontWeight.w600, fontSize: 15, color: Colors.white)),
